...
// (value, label, command, checked, active) through the same source resolution the TUI
...
// (the semantic drop); a checkbox and provider-backed TextInput get leaf state;
// a local TextInput, spacer, and container get none.
