...
if(SSG_SOURCE_DIR STREQUAL CMAKE_SOURCE_DIR)
    ...
    target_link_libraries(test_session_snapshot PRIVATE ssg)
    ...
    target_link_libraries(test_session_files PRIVATE ssg)
    ...
    target_link_libraries(test_session_external_modification PRIVATE ssg)
    ...
    target_link_libraries(test_session_editing PRIVATE ssg)
    add_test(NAME test_session_editing COMMAND test_session_editing)

    add_executable(test_session_presentation
        ${SSG_SOURCE_DIR}/tests/session/test_session_presentation.cpp
    )
    target_link_libraries(test_session_presentation PRIVATE ssg)
    add_test(NAME test_session_presentation COMMAND test_session_presentation)

    add_executable(test_session_grid_parity
        ${SSG_SOURCE_DIR}/tests/session/test_session_grid_parity.cpp
    )
    target_link_libraries(test_session_grid_parity PRIVATE ssg)
    ...
    target_link_libraries(test_session_navigation PRIVATE ssg)
    ...
    target_link_libraries(test_session_language_services PRIVATE ssg)
    ...
    target_link_libraries(test_session_totality PRIVATE ssg)
