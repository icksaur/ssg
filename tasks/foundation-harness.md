...
- Spec: `doc/spec.md`, Plan foundation
...
`include/ssg/config.h`, `tests/test_helpers.h`, `tests/test_types.cpp`

## Oracle

Valid construction/accessor round trips, invalid-construction failures, and a
compile-only consumer using the installed public include path. A fixture adds a
new component manifest without editing shared CMake files and proves its source
and standalone test are discovered, built, and registered.
